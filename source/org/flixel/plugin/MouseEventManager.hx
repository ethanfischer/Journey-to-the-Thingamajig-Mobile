...
{
	private static var _registeredObjects:Array<Dynamic><ObjectMouseData<FlxObject>>;
	private static var _mouseOverObjects:Array<Dynamic><ObjectMouseData<FlxObject>>;
	 ...
	 *
	 * @param	OnMouseDown		Callback when mouse is pressed down over this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 * @param	OnMouseUp		Callback when mouse is released over this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 * @param	OnMouseOver		Callback when mouse is this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 * @param	OnMouseOut		Callback when mouse moves out of this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 ...
	 */
	public static function add<T:FlxObject>(Dynamic:T, ?OnMouseDown:T->Void, ?OnMouseUp:T->Void, ?OnMouseOver:T->Void, ?OnMouseOut:T->Void, 
	                                        MouseChildren = false, MouseEnabled = true, PixelPerfect = true):T
	{
		...
		var newReg = new ObjectMouseData<T>(Dynamic, OnMouseDown, OnMouseUp, OnMouseOver, OnMouseOut, MouseChildren, MouseEnabled, PixelPerfect);
		
		if (Std.is(Dynamic, FlxSprite))
		{
			newReg.sprite = cast Dynamic;
		}
	 ...
	 */
	public static function remove<T:FlxObject>(Dynamic:T):T
	{
		for (reg in _registeredObjects)
		{
			if (reg.object == Dynamic)
			{
				reg.object = null;
				reg.sprite = null;
	...
	{
		var orderedObjects = new Array<Dynamic><ObjectMouseData<FlxObject>>();
		var group:Array<Dynamic><FlxBasic> = FlxG.state.members;
	 ...
	 * @param 	OnMouseDown 	Callback when mouse is pressed down over this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 */
	public static function setMouseDownCallback<T:FlxObject>(Dynamic:T, OnMouseDown:T->Void):Void
	{
		var reg = getRegister(Dynamic);
	 ...
	 * @param 	OnMouseUp 	Callback when mouse is released over this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 */
	public static function setMouseUpCallback<T:FlxObject>(Dynamic:T, OnMouseUp:T->Void):Void
	{
		var reg = getRegister(Dynamic);
	 ...
	 *
	 * @param 	OnMouseOver 	Callback when mouse is over this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 */
	public static function setMouseOverCallback<T:FlxObject>(Dynamic:T, OnMouseOver:T->Void):Void
	{
		var reg = getRegister(Dynamic);
	 ...
	 *
	 * @param 	OnMouseOver 	Callback when mouse is moves out of this object. Must have Dynamic as argument - e.g. onMouseDown(object:FlxObject).
	 */
	public static function setMouseOutCallback<T:FlxObject>(Dynamic:T, OnMouseOut:T->Void):Void
	{
		var reg = getRegister(Dynamic);
	 ...
	 */
	public static function setObjectMouseEnabled<T:FlxObject>(Dynamic:T, MouseEnabled:Bool):Void
	{
		var reg = getRegister(Dynamic);
	 ...
	 */
	public static function isObjectMouseEnabled<T:FlxObject>(Dynamic:T):Bool
	{
		var reg = getRegister(Dynamic);
	 ...
	 */
	public static function setObjectMouseChildren<T:FlxObject>(Dynamic:T, MouseChildren:Bool):Void
	{
		var reg = getRegister(Dynamic);
	 ...
	 */
	public static function isObjectMouseChildren<T:FlxObject>(Dynamic:T):Bool
	{
		var reg = getRegister(Dynamic);
	...
	private static function traverseFlxGroup(Group:FlxGroup, OrderedObjects:Array<Dynamic><ObjectMouseData<Dynamic>>):Void
	{
	...
	private static function getRegister<T:FlxObject>(Dynamic:T, ?Register:Array<Dynamic><ObjectMouseData<FlxObject>>):ObjectMouseData<T>
	{
		if (Register == null)
		{
	...
	public function new()
	{
		...
		_registeredObjects = new Array<Dynamic><ObjectMouseData<FlxObject>>();
		_mouseOverObjects = new Array<Dynamic><ObjectMouseData<FlxObject>>();
	}
	...
	override public function update():Void
	{
		...
		var currentOverObjects = new Array<Dynamic><ObjectMouseData<FlxObject>>();
