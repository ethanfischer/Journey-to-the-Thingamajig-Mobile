...
class FlxCamera extends FlxBasic
{
	 ...
	 */
	public static var defaultCameras:Array<Dynamic><FlxCamera>;
	...
	/**
	 * The alpha value of this camera display (a Float between 0.0 and 1.0).
	 */
	...
	private function render():Void
	{
		...
		while (currItem != null)
		{
			var data:Array<Dynamic><Float> = currItem.drawData;
