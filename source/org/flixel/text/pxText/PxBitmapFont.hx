...
class PxBitmapFont 
{
	...
	#if FLX_RENDER_BLIT
	private var _glyphs:Array<Dynamic><BitmapData>;
	#else
	...
	private var _tileRects:Array<Dynamic><Rectangle>;
	// Helper for angel code format font
	private var _symbols:Array<Dynamic><HelperSymbol>;
	...
	public function loadAngelCode(pBitmapData:BitmapData, pXMLData:Xml):PxBitmapFont
	{
		...
		{
			_symbols = new Array<Dynamic><HelperSymbol>();
	...
	public function preparePixelizerBitmapData(PxBitmapData:BitmapData, PxRects:Array<Dynamic><Rectangle>):BitmapData
	{
	...
	public function prepareAngelCodeBitmapData(PxBitmapData:BitmapData, PxXMLData:Xml, PxSymbols:Array<Dynamic><HelperSymbol>):BitmapData
	{
		var chars:Xml = null;
	...
	#if FLX_RENDER_BLIT
	public function getPreparedGlyphs(PxScale:Float, PxColor:Int, PxUseColorTransform:Bool = true):Array<Dynamic><BitmapData>
	{
		var result:Array<Dynamic><BitmapData> = [];
	 ...
	 */
	#if FLX_RENDER_BLIT 
	public function render(PxBitmapData:BitmapData, PxFontData:Array<Dynamic><BitmapData>, PxText:String, PxColor:Int, PxOffsetX:Int, PxOffsetY:Int, PxLetterSpacing:Int):Void 
	#else
	public function render(DrawData:Array<Dynamic><Float>, PxText:String, PxColor:Int, PxSecondColor:Int, PxAlpha:Float, PxOffsetX:Float, PxOffsetY:Float, PxLetterSpacing:Int, PxScale:Float, PxUseColor:Bool = true):Void 
	#end
	{
		#if FLX_RENDER_TILE
		var colorMultiplier:Float = 1 / 255;
	 ...
	 * 
	 * @return Float of letters available in this font.
	 */
