...
class FlxText extends FlxSprite
{
	...
	/**
	 * Internal reference to an Array<Dynamic> of FlxTextFormat
	 */
	private var _formats:Array<Dynamic><FlxTextFormat>;
	
	private var _filters:Array<Dynamic><BitmapFilter>;
	...
	public function new(X:Float = 0, Y:Float = 0, FieldWidth:Float = 0, ?Text:String, Size:Int = 8, EmbeddedFont:Bool = true)
	{
		...
		_formats = new Array<Dynamic><FlxTextFormat>();
