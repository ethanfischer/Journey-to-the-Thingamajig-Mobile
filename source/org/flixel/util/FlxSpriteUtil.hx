...
class FlxSpriteUtil
{
	 ...
	 * 
	 * @param	objects				An Array<Dynamic> of FlxObjects
	 ...
	 */
	public static function space(objects:Array<Dynamic><FlxObject>, startX:Int, startY:Int, horizontalSpacing:Int = 0, verticalSpacing:Int = 0, spaceFromBounds:Bool = false):Void
	{
		var prevWidth:Int = 0;
	 ...
	 * @param	Horizontally	Bool true if you want it centered horizontally
	 * @param	Vertically		Bool	true if you want it centered vertically
	 ...
	 * 
	 * @param	sprite		The FlxSprite to manipulate
	 * @param	Vertices	Array<Dynamic> of Vertices to use for drawing the polygon
	 ...
	 * @return 	The FlxSprite for chaining
	 */
	public static function drawPolygon(sprite:FlxSprite, Vertices:Array<Dynamic><FlxPoint>, Color:Int, ?lineStyle:LineStyle, ?fillStyle:FillStyle, ?drawStyle:DrawStyle):FlxSprite
	{
		beginDraw(Color, lineStyle, fillStyle);
	 ...
	 * @return	The FlxObject for chaining
	 */
	public static inline function flicker(Dynamic:FlxObject, Duration:Float = 1, Interval:Float = 0.04, EndVisibility:Bool = true, ForceRestart:Bool = true, ?CompletionCallback:FlxFlicker->Void, ?ProgressCallback:FlxFlicker->Void):FlxObject
	{
		FlxFlicker.flicker(Dynamic, Duration, Interval, EndVisibility, ForceRestart, CompletionCallback, ProgressCallback);
		return Dynamic;
	}
	 ...
	 * 
	 * @param  Dynamic 	The object to check against.
	 */
	public static inline function isFlickering(Dynamic:FlxObject):Bool
	{
		return FlxFlicker.isFlickering(Dynamic);
	}
	
	/**
	 * Stops flickering of the object. Also it will make the object visible.
	 * 
	 * @param  Dynamic 	The object to stop flickering.
	 * @return The FlxObject for chaining
	 */
	public static inline function stopFlickering(Dynamic:FlxObject):FlxObject
	{
		FlxFlicker.stopFlickering(Dynamic);
		return Dynamic;
	}
