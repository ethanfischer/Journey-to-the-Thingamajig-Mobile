...
{	
	@:generic
	public static inline function indexOf<T>(array:Array<Dynamic><T>, whatToFind:T, fromIndex:Int = 0):Int
	{
	 ...
	 */
	@:generic
	public static function setLength<T>(array:Array<Dynamic><T>, newLength:Int):Void
	{
	 ...
	 */
	@:generic
	public static inline function shuffle<T>(Objects:Array<Dynamic><T>, HowManyTimes:Int):Array<Dynamic><T>
	{
	 ...
	 */
	@:generic
	public static inline function getRandom<T>(Objects:Array<Dynamic><T>, StartIndex:Int = 0, EndIndex:Int = 0):T
	{
	 ...
	 */
	@:generic
	public static inline function fastSplice<T>(array:Array<Dynamic><T>, element:T):Array<Dynamic><T>
	{
	 ...
	 */
	@:generic
	public static inline function swapAndPop<T>(array:Array<Dynamic><T>, index:Int):Array<Dynamic><T>
	{
	 ...
	 */
	@:generic
	public static function clearArray<T>(array:Array<Dynamic><T>, recursive:Bool = false):Void
	{
		if (array != null)
		{
			if (!recursive)
