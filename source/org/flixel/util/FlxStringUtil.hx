...
class FlxStringUtil
{
	 ...
	 * 
	 * @param	AnyArray	Any Array<Dynamic> object.
	 * @return	A comma-separated String containing the .toString() output of each element in the array.
	 */
	public static inline function formatArray(AnyArray:Array<Dynamic><Dynamic>):String
	{
		var string:String = "";
	...
	{
		var units:Array<Dynamic><String> = ["Bytes", "kB", "MB", "GB", "TB", "PB"];
		var curUnit = 0;
	...
	/**
	 * Get the String name of any Dynamic.
	 * 
	 ...
	 */
	public static function toIntArray(Data:String):Array<Dynamic><Int>
	{
		if ((Data != null) && (Data != "")) 
		{
			var strArray:Array<Dynamic><String> = Data.split(",");
			var iArray:Array<Dynamic><Int> = new Array<Dynamic><Int>();
			for (str in strArray) 
			{
	 ...
	 */	
	public static function toFloatArray(Data:String):Array<Dynamic><Float>
	{
		if ((Data != null) && (Data != "")) 
		{
			var strArray:Array<Dynamic><String> = Data.split(",");
			var fArray:Array<Dynamic><Float> = new Array<Dynamic><Float>();
			for (str in strArray) 
			{
	 ...
	 */
	public static function arrayToCSV(Data:Array<Dynamic><Int>, Width:Int, Invert:Bool = false):String
	{
		var row:Int = 0;
		var column:Int;
		var csv:String = "";
	 ...
	 * @return	A comma-separated string containing the level data in a FlxTilemap-friendly format.
	 */
	public static function bitmapToCSV(Bitmap:BitmapData, Invert:Bool = false, Scale:Int = 1, ?ColorMap:Array<Dynamic><Int>):String
	{
		if (Scale < 1) 
		{
			Scale = 1;
	 ...
	 * 
	 * @param	LabelValuePairs		Array<Dynamic> with the data for the string
	 */
	public static function getDebugString(LabelValuePairs:Array<Dynamic><LabelValuePair>):String
	{
		var output:String = "(";
