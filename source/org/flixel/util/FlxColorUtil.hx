...
class FlxColorUtil
{
	 ...
	 * @return	HSV color wheel as Array<Dynamic> of Ints
	 */
	public static function getHSVColorWheel(Alpha:Int = 255):Array<Dynamic><Int>
	{
		var colors:Array<Dynamic><Int> = new Array<Dynamic><Int>();
	 ...
	 * @return 	Dynamic containing 3 properties: color1 (the original color), color2 (the warmer analogous color) and color3 (the colder analogous color)
	 */
	 ...
	 * 
	 * @param	Color 	The color to base the harmony on
	 * @return 	Dynamic containing 3 properties: color1 (the original color), color2 and color3 (the equidistant colors)
	 */
	 ...
	 * @return 	Dynamic with the properties hue (from 0 to 360), saturation (from 0 to 1.0) and lightness (from 0 to 1.0, also available under .value)
	 */
	 ...
	 * @param	Factor	The higher, the darker! Float from 0 to 1.0.
	 ...
	 * 
	 * @param	Color	Color in the format 0xAARRGGBB
	 * @param	Factor	The higher, the lighter! Float from 0.0 to 1.0.
