...
class FlxRandom
{
	...
	private static var _arrayFloatHelper:Array<Dynamic><Float> = null;
	 ...
	 */
	public static function intRanged(Min:Int = 0, Max:Int = MODULUS, ?Excludes:Array<Dynamic><Int>):Int
	{
		if (Min == Max)
		{
			_intHelper = Min;
	 ...
	 * @param	?Excludes	An optional array of values that should not be returned.
	 */
	public static function floatRanged(Min:Float = 0, Max:Float = 1, ?Excludes:Array<Dynamic><Float>):Float
	{
		if (Min == Max)
		{
			_floatHelper = Min;
	 ...
	 */
	public static function weightedPick(WeightsArray:Array<Dynamic><Float>):Int
	{
		_floatHelper = 0;
	 ...
	 */
	@:generic
	public static function getObject<T>(Objects:Array<Dynamic><T>, StartIndex:Int = 0, EndIndex:Int = 0):T
	{
	 ...
	 */
	@:generic
	public static function shuffleArray<T>(Objects:Array<Dynamic><T>, HowManyTimes:Int):Array<Dynamic><T>
	{
	 ...
	 */
	@:generic
	public static function weightedGetObject<T>(Objects:Array<Dynamic><T>, WeightsArray:Array<Dynamic><Float>, StartIndex:Int = 0, EndIndex:Int = 0):T
	{
		var selected:Null<T> = null;
