...
class FlxAngle
{
	 ...
	 */
	public static var cosTable:Array<Dynamic><Float> = new Array<Dynamic><Float>();
	/**
	 * Use this to access the sin-table generated via sinCosGenerator().
	 */
	public static var sinTable:Array<Dynamic><Float> = new Array<Dynamic><Float>();
	/**
	...
	public static function sinCosGenerator(length:Int, sinAmplitude:Float = 1.0, cosAmplitude:Float = 1.0, frequency:Float = 1.0):Void
	{
		...
		cosTable = new Array<Dynamic>();
		sinTable = new Array<Dynamic>();
	 ...
	 * The angle is calculated in clockwise positive direction (down = 90 degrees positive, right = 0 degrees positive, up = 90 degrees negative)
	 * 
	 * @param	Dynamic		The FlxObject to test from
	 * @param	AsDegrees	If you need the value in degrees instead of radians, set to true
	 * @return	The angle (in radians unless AsDegrees is true)
	 */
	public static function angleBetweenMouse(Dynamic:FlxObject, AsDegrees:Bool = false):Float
	{
		//	In order to get the angle between the object and mouse, we need the objects screen coordinates (rather than world coordinates)
		if (Dynamic == null)
			return 0;
		
		var p:FlxPoint = Dynamic.getScreenXY();
	 ...
	 * @return	The angle (in radians unless AsDegrees is true)
	 */
	public static inline function angleBetweenTouch(Dynamic:FlxObject, Touch:FlxTouch, AsDegrees:Bool = false):Float
	{
		//	In order to get the angle between the object and mouse, we need the objects screen coordinates (rather than world coordinates)
		var p:FlxPoint = Dynamic.getScreenXY();
