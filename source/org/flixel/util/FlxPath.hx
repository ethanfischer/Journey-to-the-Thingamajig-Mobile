...
class FlxPath implements IFlxDestroyable
{
	 ...
	 */
	public var nodes:Array<Dynamic><FlxPoint>;
	
	/**
	 * Dynamic which will follow this path
	 */
	 ...
	 * NOTE: does not affect world movement!  Dynamic scroll factors take care of that.
	 */
	...
	/**
	 * Creates a new FlxPath (and calls start() right away if Dynamic != null).
	 */
	public function new(?Dynamic:FlxObject, ?Nodes:Array<Dynamic><FlxPoint>, Speed:Float = 100, Mode:Int = FlxPath.FORWARD, AutoRotate:Bool = false) 
	{
		if (Dynamic != null)
		{
			start(Dynamic, Nodes, Speed, Mode, AutoRotate);
		}
	}
	...
	public function start(Dynamic:FlxObject, Nodes:Array<Dynamic><FlxPoint>, Speed:Float = 100, Mode:Int = FlxPath.FORWARD, AutoRotate:Bool = false):FlxPath
	{
		object = Dynamic;
		nodes = Nodes;
