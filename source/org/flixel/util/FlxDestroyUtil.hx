...
class FlxDestroyUtil
{
	...
	/**
	 * Completely destroys an Array<Dynamic> of destroyable objects:
	 * 1) Clears the array structure
	 * 2) Calls FlxDestroyUtil.destroy() on every element
	 *
	 * @param	array	An Array<Dynamic> of IFlxDestroyable objects
	 * @return	null
	 */
	public static function destroyArray<T:IFlxDestroyable>(array:Array<Dynamic><T>):Array<Dynamic><T>
	{
		if (array != null)
		{
	...
	/**
	 * Puts all objects in an Array<Dynamic> of IFlxPooled objects back into 
	 * the pool by calling FlxDestroyUtil.put() on them
	 *
	 * @param	array	An Array<Dynamic> of IFlxPooled objects
	 * @return	null
	 */
	public static function putArray<T:IFlxPooled>(array:Array<Dynamic><T>):Array<Dynamic><T>
	{
		if (array != null)
		{
			while (array.length > 0)
