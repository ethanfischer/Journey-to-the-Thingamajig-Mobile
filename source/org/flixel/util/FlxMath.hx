...
{	
	 ...
	 * @param	Precision	Float of decimal points to leave in float. Should be a positive number
	 ...
	 * @return	The distance between the two points as a floating point Float object.
	 */
	 ...
	 */
	public static function getDecimals(Float:Float):Int
	{
		var helperArray:Array<Dynamic><String> = Std.string(Float).split(".");
		var decimals:Int = 0;
