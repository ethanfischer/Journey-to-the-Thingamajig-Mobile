...
class FlxGradient
{
	public static function createGradientMatrix(width:Int, height:Int, colors:Array<Dynamic><Int>, chunkSize:Int = 1, rotation:Int = 90):GradientMatrix
	{
		...
		var alpha:Array<Dynamic><Float> = new Array<Dynamic>();
		...
		var ratio:Array<Dynamic><Int> = new Array<Dynamic>();
	...
	public static function createGradientArray(width:Int, height:Int, colors:Array<Dynamic><Int>, chunkSize:Int = 1, rotation:Int = 90, interpolate:Bool = true):Array<Dynamic><Int>
	{
		var data:BitmapData = createGradientBitmapData(width, height, colors, chunkSize, rotation, interpolate);
		var result:Array<Dynamic><Int> = new Array<Dynamic>();
	 ...
	 */
	public static function createGradientFlxSprite(width:Int, height:Int, colors:Array<Dynamic><Int>, chunkSize:Int = 1, rotation:Int = 90, interpolate:Bool = true):FlxSprite
	{
		var data:BitmapData = createGradientBitmapData(width, height, colors, chunkSize, rotation, interpolate);
	...
	public static function createGradientBitmapData(width:Int, height:Int, colors:Array<Dynamic><Int>, chunkSize:Int = 1, rotation:Int = 90, interpolate:Bool = true):BitmapData
	{
		//	Sanity checks
		if (width < 1)
		{
	 ...
	 */
	public static function overlayGradientOnFlxSprite(dest:FlxSprite, width:Int, height:Int, colors:Array<Dynamic><Int>, destX:Int = 0, destY:Int = 0, chunkSize:Int = 1, rotation:Int = 90, interpolate:Bool = true):FlxSprite
	{
		if (width > dest.width)
		{
	 ...
	 */
	public static function overlayGradientOnBitmapData(dest:BitmapData, width:Int, height:Int, colors:Array<Dynamic><Int>, destX:Int = 0, destY:Int = 0, chunkSize:Int = 1, rotation:Int = 90, interpolate:Bool = true):BitmapData
	{
		if (width > dest.width)
		{
			width = dest.width;
...
typedef GradientMatrix = {
    var matrix:Matrix;
    var alpha:Array<Dynamic><Float>;
    var ratio:Array<Dynamic><Int>;
}