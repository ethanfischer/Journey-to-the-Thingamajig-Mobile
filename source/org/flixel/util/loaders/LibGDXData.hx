...
class LibGDXData extends TexturePackerData
{
	...
	override public function parseData():Void
	{
		...
		var lines:Array<Dynamic><String> = pack.split("\n");
		lines.splice(0, 4);
	...
	private function getDimensions(line:String, size:Array<Dynamic><Int>):Array<Dynamic><Int>
	{
