...
class FlxAnimationController implements IFlxDestroyable
{
	 ...
	 */
	public function add(Name:String, Frames:Array<Dynamic><Int>, FrameRate:Int = 30, Looped:Bool = true):Void
	{
	...
	*/
	public function append(Name:String, Frames:Array<Dynamic><Int>):Void
	{
	 ...
	 * @param	Looped			Whether or not the _animations is looped or just plays once.
	 */
	public function addByNames(Name:String, FrameNames:Array<Dynamic><String>, FrameRate:Int = 30, Looped:Bool = true):Void
	{
		if (_sprite.cachedGraphics != null && _sprite.cachedGraphics.data != null)
		{
			var indices:Array<Dynamic><Int> = new Array<Dynamic><Int>();
	...
	*/
	public function appendByNames(Name:String, FrameNames:Array<Dynamic><String>):Void
	{
		var anim:FlxAnimation = _animations.get(Name);
	 ...
	 * @param	Looped			Whether or not the _animations is looped or just plays once.
	 */
	public function addByStringIndices(Name:String, Prefix:String, Indices:Array<Dynamic><String>, Postfix:String, FrameRate:Int = 30, Looped:Bool = true):Void
	{
		if (_sprite.cachedGraphics != null && _sprite.cachedGraphics.data != null)
		{
			var frameIndices:Array<Dynamic><Int> = new Array<Dynamic><Int>();
	 ...
	 * @param	Postfix			Common ending of image names in atlas (e.g. ".png")
	*/
	public function appendByStringIndices(Name:String, Prefix:String, Indices:Array<Dynamic><String>, Postfix:String):Void
	{
		var anim:FlxAnimation = _animations.get(Name);
	 ...
	 * @param	Looped			Whether or not the _animations is looped or just plays once.
	 */
	public function addByIndices(Name:String, Prefix:String, Indices:Array<Dynamic><Int>, Postfix:String, FrameRate:Int = 30, Looped:Bool = true):Void
	{
		if (_sprite.cachedGraphics != null && _sprite.cachedGraphics.data != null)
		{
			var frameIndices:Array<Dynamic><Int> = new Array<Dynamic><Int>();
	 ...
	 * @param	Postfix			Common ending of image names in atlas (e.g. ".png")
	*/
	public function appendByIndices(Name:String, Prefix:String, Indices:Array<Dynamic><Int>, Postfix:String):Void
	{
		var anim:FlxAnimation = _animations.get(Name);
	...
	private function findSpriteFrame(Prefix:String, Index:Int, Postfix:String):Int
	{
		...
		var flxFrames:Array<Dynamic><FlxFrame> = _sprite.framesData.frames;
	...
	*/
	public function addByPrefix(Name:String, Prefix:String, FrameRate:Int = 30, Looped:Bool = true):Void
	{
		if (_sprite.cachedGraphics != null && _sprite.cachedGraphics.data != null)
		{
			var animFrames:Array<Dynamic><FlxFrame> = new Array<Dynamic><FlxFrame>();
	...
	*/
	 ...
	 */
	private function byNamesHelper(AddTo:Array<Dynamic><Int>, FrameNames:Array<Dynamic><String>):Void
	{
	 ...
	 */
	private function byStringIndicesHelper(AddTo:Array<Dynamic><Int>, Prefix:String, Indices:Array<Dynamic><String>, Postfix:String):Void
	{
	 ...
	 */
	private function byIndicesHelper(AddTo:Array<Dynamic><Int>, Prefix:String, Indices:Array<Dynamic><Int>, Postfix:String):Void
	{
		var l:Int = Indices.length;
		for (i in 0...l)
		{
	 ...
	 */
	private function byPrefixHelper(AddTo:Array<Dynamic><Int>, AnimFrames:Array<Dynamic><FlxFrame>, Prefix:String):Void
	{
	 ...
	 */
	private function findByPrefix(AnimFrames:Array<Dynamic><FlxFrame>, Prefix:String):Void
	{
