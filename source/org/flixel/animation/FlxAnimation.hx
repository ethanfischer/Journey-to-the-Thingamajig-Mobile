...
class FlxAnimation extends FlxBaseAnimation
{
	...
	private var _frames:Array<Dynamic><Int>;
	 ...
	 */
	public function new(Parent:FlxAnimationController, Name:String, Frames:Array<Dynamic><Int>, FrameRate:Int = 0, Looped:Bool = true)
	{
		super(Parent, Name);
