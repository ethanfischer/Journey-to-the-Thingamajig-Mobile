...
class FlxReplay
{
	 ...
	 */
	private var _frames:Array<Dynamic><FrameRecord>;
	/**
	...
	public function load(FileContents:String):Void
	{
		...
		var lines:Array<Dynamic><String> = FileContents.split("\n");
	...
	public function recordFrame():Void
	{
		...
		#if !FLX_NO_KEYBOARD
		var keysRecord:Array<Dynamic><CodeValuePair> = FlxG.keys.record();
	...
	{
		_capacity = 100;
		_frames = new Array<Dynamic><FrameRecord>(/*_capacity*/);
		FlxArrayUtil.setLength(_frames, _capacity);
		frameCount = 0;
	}
}