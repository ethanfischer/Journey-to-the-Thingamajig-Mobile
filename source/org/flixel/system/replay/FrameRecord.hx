...
class FrameRecord
{
	 ...
	 */
	public var keys:Array<Dynamic><CodeValuePair>;
	/**
	 ...
	 */
	public function create(Frame:Float, Keys:Array<Dynamic><CodeValuePair> = null, Mouse:MouseRecord = null):FrameRecord
	{
	...
	public function load(Data:String):FrameRecord
	{
		...
		//get frame number
		var array:Array<Dynamic><String> = Data.split("k");
		...
		if (keyData.length > 0)
		{
			...
			var keyPair:Array<Dynamic><String>;
			i = 0;
			l = array.length;
			while (i < l)
			{
				...
				if (keyPair.length == 2)
				{
					if (keys == null)
					{
						keys = new Array<Dynamic><CodeValuePair>();
					}
