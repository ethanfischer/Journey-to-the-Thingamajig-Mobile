...
class ConsoleCommands
{
	...
	{
		_console.cmdHistory = new Array<Dynamic><String>();
		FlxG.save.flush();
	...
	private function create(ClassName:String, MousePos:String = "true", ?Params:Array<Dynamic><String>):Void
	{	
		if (Params == null)
			Params = [];
	...
	private function fields(ObjectAndVariable:String, NumSuperClassesToInclude:Int = 0):Void
	{
		...
		var fields:Array<Dynamic><String> = [];
	...
	private function call(FunctionAlias:String, ?Params:Array<Dynamic><String>):Void
	{	
		if (Params == null)
			Params = [];
		...
		{
			var searchArr:Array<Dynamic><String> = FunctionAlias.split(".");
