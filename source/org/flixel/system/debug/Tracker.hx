...
class Tracker extends Watch
{
	 ...
	 */
	public static var profiles:Array<Dynamic><TrackerProfile>;
	 ...
	 */ 
	public static var objectsBeingTracked:Array<Dynamic><Dynamic> = [];
	...
	public static function findProfile(Dynamic:Dynamic):TrackerProfile
	{
		initProfiles();
		...
		{
			if (Std.is(Dynamic, profile.objectClass) || (Dynamic == profile.objectClass))
			{
	...
	public function new(Profile:TrackerProfile, Dynamic:Dynamic, ?WindowTitle:String) 
	{
		super(true);
	...
	private function addVariables(Variables:Array<Dynamic><String>):Void
	{
		if (Variables != null)
		{
...
class TrackerProfile
{
	...
	public var variables:Array<Dynamic><String>;
	public var extensions:Array<Dynamic><Class<Dynamic>>;
	
	public function new(ObjectClass:Class<Dynamic>, ?Variables:Array<Dynamic><String>, ?Extensions:Array<Dynamic><Class<Dynamic>>)
	{
