...
class Stats extends Window
{
	...
	private var _update:Array<Dynamic><Int>;
	private var _updateMarker:Int = 0;
	
	private var _draw:Array<Dynamic><Int>;
	private var _drawMarker:Int = 0;
	
	private var _visibleObject:Array<Dynamic><Int>;
	private var _visibleObjectMarker:Int = 0;
	
	private var _activeObject:Array<Dynamic><Int>;
	...
	private var _drawCalls:Array<Dynamic><Int>;
