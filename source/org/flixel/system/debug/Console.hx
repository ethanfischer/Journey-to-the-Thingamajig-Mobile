...
class Console extends Window
{
	 ...
	 */
	public var objectStack:Array<Dynamic><FlxObject>;
	
	/**
	 * Reference to the array containing the command history.
	 */
	public var cmdHistory:Array<Dynamic><String>;
	/**
	 * An array holding all the registered commands.
	 */
	public var commands:Array<Dynamic><Command>;
	...
	{	
		...
		commands = new Array<Dynamic><Command>();
		
		registeredObjects = new Map<String, Dynamic>();
		registeredFunctions = new Map<String, Dynamic>();
		
		objectStack = new Array<Dynamic><FlxObject>();
		
		cmdHistory = new Array<Dynamic><String>();
	...
	{
		var args:Array<Dynamic><Dynamic> = StringTools.rtrim(_input.text).split(" ");
	 ...
	 */
	public inline function addCommand(Aliases:Array<Dynamic><String>, ProcessFunction:Dynamic, ?Help:String, ?ParamHelp:String, NumParams:Int = 0, ParamCutoff:Int = -1):Void
	{
