...
class Watch extends Window
{
	...
	private var _watching:Array<Dynamic><WatchEntry>;
	...
	public function new(Closable:Bool = false)
	{
		...
		_watching = new Array<Dynamic><WatchEntry>();
	 ...
	 * 
	 * @param 	AnyObject		The Dynamic containing the variable you want to track, e.g. this or Player.velocity.
	 ...
	 * 
	 * @param 	AnyObject		The Dynamic containing the variable you want to remove, e.g. this or Player.velocity.
