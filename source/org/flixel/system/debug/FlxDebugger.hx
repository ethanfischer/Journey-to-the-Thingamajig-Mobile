...
class FlxDebugger extends Sprite
{
	 ...
	 */
	public function hAlignButtons(Sprites:Array<Dynamic><FlxSystemButton>, Padding:Float = 0, Set:Bool = true, LeftOffset:Float = 0):Float
	{
		var width:Float = 0;
	...
	public function addButton(Position:ButtonAlignment, ?Icon:BitmapData, ?UpHandler:Void->Void, ToggleMode:Bool = false, UpdateLayout:Bool = false):FlxSystemButton
	{
		...
		var array:Array<Dynamic><FlxSystemButton>; 
		switch (Position)
		{
			case LEFT:
				array = _leftButtons;
	...
	private function removeButtonFromArray(Arr:Array<Dynamic><FlxSystemButton>, Button:FlxSystemButton):Void
	{
