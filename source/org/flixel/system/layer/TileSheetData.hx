...
/**
 * Dynamic of this class holds information about single Tilesheet
 */
class TileSheetData implements IFlxDestroyable
{
	...
	private var frameNames:Array<Dynamic><String>;
	
	private var framesArr:Array<Dynamic><FlxFrame>;
	...
	public function new(Bitmap:BitmapData)
	{
		...
		frameNames = new Array<Dynamic><String>();
		framesArr = new Array<Dynamic><FlxFrame>();
	}
