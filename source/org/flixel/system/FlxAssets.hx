...
class FlxAssets
{
	 ...
	 */
	macro public static function buildFileReferences(directory:String = "assets/", subDirectories:Bool = false, ?filterExtensions:Array<Dynamic><String>):Array<Dynamic><Field>
	{
		if (!directory.endsWith("/"))
			directory += "/";
		
		var fileReferences:Array<Dynamic><FileReference> = getFileReferences(directory, subDirectories, filterExtensions);
		
		var fields:Array<Dynamic><Field> = Context.getBuildFields();
	...
	private static function getFileReferences(directory:String, subDirectories:Bool = false, ?filterExtensions:Array<Dynamic><String>):Array<Dynamic><FileReference>
	{
		var fileReferences:Array<Dynamic><FileReference> = [];
...
private class FileReference
{
	...
	public function new(value:String)
	{
		...
		var split:Array<Dynamic><String> = name.split("/");
