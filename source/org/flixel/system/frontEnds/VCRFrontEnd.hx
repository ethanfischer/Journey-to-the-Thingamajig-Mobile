...
class VCRFrontEnd
{
#if FLX_RECORD
	#if flash
	private static var FILE_TYPES:Array<Dynamic><FileFilter> = [new FileFilter("Flixel Game Recording", "*.fgr")];
	 ...
	 */
	public var cancelKeys:Array<Dynamic><String>;
	/**
	 ...
	 */
	public function loadReplay(Data:String, ?State:FlxState, ?CancelKeys:Array<Dynamic><String>, ?Timeout:Float = 0, ?Callback:Void->Void):Void
	{
