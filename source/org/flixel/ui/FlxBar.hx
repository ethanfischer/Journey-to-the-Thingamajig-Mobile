...
class FlxBar extends FlxSprite
{
	...
	private var _filledBarFrames:Array<Dynamic><Float>;
	 ...
	 * All colour values are in 0xAARRGGBB format, so if you want a slightly transparent health bar give it lower AA values.
	 * 
	 * @param	empty		Array<Dynamic> of colour values used to create the gradient of the health bar when empty, each colour must be in 0xAARRGGBB format (the background colour)
	 * @param	fill		Array<Dynamic> of colour values used to create the gradient of the health bar when full, each colour must be in 0xAARRGGBB format (the foreground colour)
	 ...
	 * @param	border		The border colour in 0xAARRGGBB format
	 */
	public function createGradientBar(empty:Array<Dynamic><Int>, fill:Array<Dynamic><Int>, chunkSize:Int = 1, rotation:Int = 180, showBorder:Bool = false, border:Int = 0xffffffff):Void
	{
	...
	override public function draw():Void 
	{
		...
		var currDrawData:Array<Dynamic><Float>;
		var currIndex:Int;
