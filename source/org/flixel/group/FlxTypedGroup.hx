...
{
	/**
	 * Array<Dynamic> of all the members in this group.
	 */
	public var members(default, null):Array<Dynamic><T>;
	/**
	 ...
	 * 
	 * @param	Dynamic		The object you want to add to the group.
	 * @return	The same FlxBasic object that was passed in.
	 */
	public function add(Dynamic:T):T
	{
		if (Dynamic == null)
		{
		...
		// If the group is full, return the Dynamic
	 ...
	 */
	public function recycle(?ObjectClass:Class<T>, ?ContructorArgs:Array<Dynamic><Dynamic>, Force:Bool = false, Revive:Bool = true):T
	{
	 ...
	 * 
	 * @param	Dynamic	The FlxBasic you want to remove.
	...
	public function remove(Dynamic:T, Splice:Bool = false):T
	{
		...
		var index:Int = members.indexOf(Dynamic);
	 ...
	 */ 
	public function callAll(FunctionName:String, ?Args:Array<Dynamic><Dynamic>, Recurse:Bool = true):Void
	{
		if (Args == null)
			Args = [];
