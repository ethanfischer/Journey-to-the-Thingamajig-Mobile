...
class FlxTypedSpriteGroup<T:FlxSprite> extends FlxSprite
{
	 ...
	 */
	public var members(get, null):Array<Dynamic><T>;
	...
	/**
	 * Array<Dynamic> of all the FlxSprites that exist in this group for 
	 * optimization purposes / static typing on cpp targets.
	 */
	private var _sprites:Array<Dynamic><FlxSprite>;
	 ...
	 * @return	Array<Dynamic> replaced pixels positions
	 */
	override public function replaceColor(Color:Int, NewColor:Int, FetchPositions:Bool = false):Array<Dynamic><FlxPoint> 
	{
		var positions:Array<Dynamic><FlxPoint> = null;
		if (FetchPositions)
		{
			positions = new Array<Dynamic><FlxPoint>();
		}
		
		var spritePositions:Array<Dynamic><FlxPoint>;
		for (sprite in _sprites)
		{
			if (sprite != null)
			{
	 ...
	 * 
	 * @param	Dynamic		The sprite or sprite group you want to add to the group.
	 ...
	 */
	public inline function recycle(?ObjectClass:Class<T>, ?ContructorArgs:Array<Dynamic><Dynamic>, Force:Bool = false):FlxSprite
	{
	 ...
	 * 
	 * @param	Dynamic	The FlxSprite you want to remove.
	 * @param	Splice	Whether the object should be cut from the array entirely or not.
	 * @return	The removed object.
	 */
	public function remove(Dynamic:T, Splice:Bool = false):T
	{
		return group.remove(Dynamic, Splice);
	}
	 ...
	 */ 
	public inline function callAll(FunctionName:String, ?Args:Array<Dynamic><Dynamic>, Recurse:Bool = true):Void
	{
	 ...
	 * 
	 * @param	FunctionArray	Array<Dynamic> of functions to transform sprites in this group.
	 * @param	ValueArray		Array<Dynamic> of values which will be passed to lambda functions
	 */
	@:generic
	public function multiTransformChildren<V>(FunctionArray:Array<Dynamic><T->V->Void>, ValueArray:Array<Dynamic><V>):Void
	{
		if (group == null) 
		{
			return;
	...
	override private function set_cameras(Value:Array<Dynamic><FlxCamera>):Array<Dynamic><FlxCamera>
	{
		if (cameras != Value)
	...
	private inline function get_members():Array<Dynamic><T>
	{
	...
	private inline function camerasTransform(Sprite:FlxSprite, Cameras:Array<Dynamic><FlxCamera>)		{ Sprite.cameras = Cameras; }						// set
