...
/**
 * Tweens multiple numeric public properties of an Dynamic simultaneously.
 */
class VarTween extends FlxTween
{
	private var _object:Dynamic;
	private var _properties:Dynamic;
	private var _vars:Array<Dynamic><String>;
	private var _startValues:Array<Dynamic><Float>;
	private var _range:Array<Dynamic><Float>;
