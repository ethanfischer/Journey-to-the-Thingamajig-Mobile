...
class FlxTween implements IFlxDestroyable
{
	...
	/**
	 * Tweens numeric public properties of an Dynamic. Shorthand for creating a VarTween, starting it and adding it to the TweenManager.
	 * Example: FlxTween.tween(Dynamic, { x: 500, y: 350 }, 2.0, { ease: easeFunction, complete: onComplete, type: FlxTween.ONESHOT });
	 * 
	 * @param	Dynamic		The object containing the properties to tween.
	 ...
	 */
	public static function tween(Dynamic:Dynamic, Values:Dynamic, Duration:Float = 1, ?Options:TweenOptions):VarTween
	{
		var tween = new VarTween(Options);
		tween.tween(Dynamic, Values, Duration);
	 ...
	 * Example: FlxTween.linearMotion(Dynamic, 0, 0, 500, 20, 5, false, { ease: easeFunction, complete: onComplete, type: FlxTween.ONESHOT });
	 * 
	 * @param	Dynamic			The object to move (FlxObject or FlxSpriteGroup)
	 * @param	FromX			X start.
	 * @param	FromY			Y start.
	 * @param	ToX				X finish.
	 * @param	ToY				Y finish.
	 ...
	 */
	public static function linearMotion(Dynamic:FlxObject, FromX:Float, FromY:Float, ToX:Float, ToY:Float, DurationOrSpeed:Float = 1, UseDuration:Bool = true, ?Options:TweenOptions):LinearMotion
	{
		var tween = new LinearMotion(Options);
		tween.setObject(Dynamic);
	 ...
	 * Example: FlxTween.quadMotion(Dynamic, 0, 100, 300, 500, 100, 2, 5, false, { ease: easeFunction, complete: onComplete, type: FlxTween.ONESHOT });
	 * 
	 * @param	Dynamic			The object to move (FlxObject or FlxSpriteGroup)
	 * @param	FromX			X start.
	 * @param	FromY			Y start.
	 ...
	 */
	public static function quadMotion(Dynamic:FlxObject, FromX:Float, FromY:Float, ControlX:Float, ControlY:Float, ToX:Float, ToY:Float, DurationOrSpeed:Float = 1, UseDuration:Bool = true, ?Options:TweenOptions):QuadMotion
	{
	 ...
	 */
	public static function cubicMotion(Dynamic:FlxObject, FromX:Float, FromY:Float, aX:Float, aY:Float, bX:Float, bY:Float, ToX:Float, ToY:Float, Duration:Float = 1, ?Options:TweenOptions):CubicMotion
	{
	 ...
	 * Example: FlxTween.circularMotion(Dynamic, 250, 250, 50, 0, true, 2, true { ease: easeFunction, complete: onComplete, type: FlxTween.ONESHOT });
	 * 
	 * @param	Dynamic			The object to move (FlxObject or FlxSpriteGroup)
	 ...
	 */
	public static function circularMotion(Dynamic:FlxObject, CenterX:Float, CenterY:Float, Radius:Float, Angle:Float, Clockwise:Bool, DurationOrSpeed:Float = 1, UseDuration:Bool = true, ?Options:TweenOptions):CircularMotion
	{
	 ...
	 * Example: FlxTween.linearPath(Dynamic, [FlxPoint.get(0, 0), FlxPoint.get(100, 100)], 2, true, { ease: easeFunction, complete: onComplete, type: FlxTween.ONESHOT });
	 * 
	 * @param	Dynamic 			The object to move (FlxObject or FlxSpriteGroup)
	 ...
	 */
	public static function linearPath(Dynamic:FlxObject, Points:Array<Dynamic><FlxPoint>, DurationOrSpeed:Float = 1, UseDuration:Bool = true, ?Options:TweenOptions):LinearPath
	{
	 ...
	 * Example: FlxTween.quadPath(Dynamic, [FlxPoint.get(0, 0), FlxPoint.get(200, 200), FlxPoint.get(400, 0)], 2, true, { ease: easeFunction, complete: onComplete, type: FlxTween.ONESHOT });
	 * 
	 * @param	Dynamic			The object to move (FlxObject or FlxSpriteGroup)
	 ...
	 */
	public static function quadPath(Dynamic:FlxObject, Points:Array<Dynamic><FlxPoint>, DurationOrSpeed:Float = 1, UseDuration:Bool = true, ?Options:TweenOptions):QuadPath
	{
