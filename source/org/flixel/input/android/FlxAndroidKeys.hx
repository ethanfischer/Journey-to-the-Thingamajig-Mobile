...
class FlxAndroidKeys implements IFlxInput
{
	 ...
	 */
	public inline function anyPressed(KeyArray:Array<Dynamic><Dynamic>):Bool
	{
	 ...
	 */
	public inline function anyJustPressed(KeyArray:Array<Dynamic><Dynamic>):Bool
	{
	 ...
	 */
	public inline function anyJustReleased(KeyArray:Array<Dynamic><Dynamic>):Bool
	{
	...
	/**
	 * Get an Array<Dynamic> of FlxMapObjects that are in a pressed state
	 *
	 * @return	Array<Dynamic><FlxMapObject> of keys that are currently pressed.
	 */
	 ...
	 */
	private function checkKeyStatus(KeyArray:Array<Dynamic><Dynamic>, Status:Int):Bool
	{
		if (KeyArray == null)
		{
			return false;
