...
class FlxGamepad implements IFlxDestroyable
{
	...
	public var id:Int;
	public var buttons:Array<Dynamic><FlxGamepadButton>;
	 ...
	 */
	private var axis:Array<Dynamic><Float>;
	 ...
	 */
	public function anyPressed(ButtonIDArray:Array<Dynamic><Int>):Bool
	{
	 ...
	 */
	public function anyJustPressed(ButtonIDArray:Array<Dynamic><Int>):Bool
	{
		for (b in ButtonIDArray)
		{
			if (buttons[b] != null)
	 ...
	 */
	public function anyJustReleased(ButtonIDArray:Array<Dynamic><Int>):Bool
	{
		for (b in ButtonIDArray)
		{
			if (buttons[b] != null)
