...
class FlxGamepadManager implements IFlxInput
{
	 ...
	 */
	private var _gamepads:Array<Dynamic><FlxGamepad>;
	 ...
	 */
	public function getActiveGamepadIDs(?IDsArray:Array<Dynamic><Int>):Array<Dynamic><Int>
	{
		if (IDsArray == null)
		{
			IDsArray = [];
	 ...
	 */
	public function getActiveGamepads(?GamepadArray:Array<Dynamic><FlxGamepad>):Array<Dynamic><FlxGamepad>
	{
