...
class FlxKeyboard implements IFlxInput
{
	...
	private var _keyList:Array<Dynamic><FlxKey>;
	/**
	 ...
	 */
	public inline function anyPressed(KeyArray:Array<Dynamic><String>):Bool
	{ 
	 ...
	 */
	public inline function anyJustPressed(KeyArray:Array<Dynamic><String>):Bool
	{ 
	 ...
	 */
	public inline function anyJustReleased(KeyArray:Array<Dynamic><String>):Bool
	{ 
	...
	/**
	 * Get an Array<Dynamic> of FlxKey that are in a pressed state
	 * 
	 * @return	Array<Dynamic><FlxKey> of keys that are currently pressed.
	 */
	public function getIsDown():Array<Dynamic><FlxKey>
	{
		var keysDown:Array<Dynamic><FlxKey> = new Array<Dynamic><FlxKey>();
	...
	private function new()
	{
		...
		_keyList = new Array<Dynamic><FlxKey>();
	 ...
	 */
	private function checkKeyStatus(KeyArray:Array<Dynamic><String>, Status:Int):Bool
	{
		if (KeyArray == null)
		{
			return false;
	 ...
	 */
	private function inKeyArray(KeyArray:Array<Dynamic><String>, KeyCode:Int):Bool
	{
		if (KeyArray == null)
		{
			return false;
	 ...
	 */
	private function record():Array<Dynamic><CodeValuePair>
	{
		var data:Array<Dynamic><CodeValuePair> = null;
		var i:Int = 0;
		...
		while (i < TOTAL)
		{
			...
			if (data == null)
			{
				data = new Array<Dynamic><CodeValuePair>();
			}
	 ...
	 * 
	 * @param	Record	Array<Dynamic> of data about key states.
	 */
	private function playback(Record:Array<Dynamic><CodeValuePair>):Void
	{
		var i:Int = 0;
