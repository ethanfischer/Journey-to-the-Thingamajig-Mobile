...
{	
	...
	private var _tempStorage:Array<Dynamic><TempAtlasObj>;
	 ...
	 */
	public function addNodes(bitmaps:Array<Dynamic><BitmapData>, keys:Array<Dynamic><String>):Bool
	{
		...
		var sortedBitmaps:Array<Dynamic><BitmapData> = bitmaps.slice(0, bitmaps.length);
	...
	private function indexOf(bitmaps:Array<Dynamic><BitmapData>, bmd:BitmapData):Int
	{
	...
	{
		_tempStorage = new Array<Dynamic><TempAtlasObj>();
	}
	...
	public function generateAtlasFromQueue():Void
	{
		if (_tempStorage != null)
		{
			var bitmaps:Array<Dynamic><BitmapData> = new Array<Dynamic><BitmapData>();
			var keys:Array<Dynamic><String> = new Array<Dynamic><String>();
	...
	{
		// Node stack
		var stack:Array<Dynamic><FlxNode> = new Array<Dynamic><FlxNode>();
		// Current node
