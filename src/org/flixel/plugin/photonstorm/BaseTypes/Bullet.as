...
package org.flixel.plugin.photonstorm.BaseTypes 
{
	...
	public class Bullet extends FlxSprite
	{
		...
		public var poofed:Boolean = false;
		...
		public function Bullet(weapon:FlxWeapon, id:uint)
		{
			...
			addAnimation("explode", [2,3,4,5], 60, false);
			
			this.weapon = weapon;
			this.ID = id;
			this.width = 16;   // because image is 32 pixels
			//this.offset.x = 8; // becase image of bullet is offset by 8
			//this.height = 2;
			//this.offset.y = 4;
